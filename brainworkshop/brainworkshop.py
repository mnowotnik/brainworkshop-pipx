...
def pyglet_load_traversable(package, resource):
    with resources.files(package).joinpath(resource).open(mode='rb') as f:
...
CONFIGFILE_DEFAULT_CONTENTS = r"""
######################################################################
# Brain Workshop configuration file
# generated by Brain Workshop """ + VERSION + r"""
#
...
for k in list(resourcepaths['sounds']):
    ...
    for static_path in resourcepaths['sounds'][k]:
        static_path: TraversableResources
